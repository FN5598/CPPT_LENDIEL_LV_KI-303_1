...
/**
 * Reads release metadata generated from the Maven project properties.
 */
public final class VersionInfo {
    ...
    /**
     * Returns the Maven version of the currently checked-out cumulative release.
     *
    ...
    /**
     * Returns the version assigned to one laboratory release.
     *
     * @param lab laboratory key such as {@code lab01}
     * @return laboratory version
     * @throws IllegalArgumentException if the laboratory key is blank or unknown
     */
